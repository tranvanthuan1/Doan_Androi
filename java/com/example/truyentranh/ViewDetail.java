...
import com.example.truyentranh.Adapter.MyChapterAdapter;
import com.example.truyentranh.Adapter.MyViewPagerAdapter;
import com.example.truyentranh.Common.Common;
import com.example.truyentranh.Model.Chapter;
import com.example.truyentranh.Model.Link;
...
public class ViewDetail extends AppCompatActivity {
  // IComicAPI iComicAPI;
    ...
    Button btnyeuthich,btndanhgia,btnchiase;
    View back, next;
    Cursor c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // tạo đối tương db để thao tác với dữ liệu trong database
        ...
        btnyeuthich = (Button) findViewById(R.id.btyeuthich);
        btnchiase = (Button) findViewById(R.id.btchiase);
        btndanhgia = (Button) findViewById(R.id.btdanhgia);
        ...
        btnyeuthich.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ViewDetail.this,"Đã yêu thích",Toast.LENGTH_SHORT).show();
                Log.e("Yêu thích: ","Đã yêu thích");
            }
        });
        ...
        btnchiase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ViewDetail.this,MainChiaSe.class);
